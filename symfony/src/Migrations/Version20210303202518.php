...
final class Version20210303202518 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE discipline (id SERIAL NOT NULL, name VARCHAR(50) NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE department_disciplines (discipline_id INT NOT NULL, department_id INT NOT NULL, PRIMARY KEY(discipline_id, department_id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE department_disciplines DROP CONSTRAINT FK_433FB87AE80F5DF');
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT user__department_id__fk');
        $this->addSql('ALTER TABLE department_disciplines DROP CONSTRAINT FK_433FB87A5522701');
